...
function dselect(el, option = {}) {
    ...
    const searchInput = search
        ? `<input autocomplete="false" onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="Nhập từ khóa tìm kiếm" autofocus>`
        : "";
        ...
        if (multiple) {
            ...
            if (selectedOptions.length === 0) {
                ...
                for (const option of selectedOptions) {
                    tag.push(`
            <span class="${classTag}" data-dselect-value="${option.value}">
              ${option.text}
    ...
    <div class="dropdown ${classElement} ${additionalClass}">
      ...
      <div class="dropdown-menu">
        <div class="d-flex flex-column">
          ...
          <div class="${classNoResults} d-none">Không có kết quả được tìm thấy</div>
        </div>
      </div>
      ${clearBtn}
    </div>
